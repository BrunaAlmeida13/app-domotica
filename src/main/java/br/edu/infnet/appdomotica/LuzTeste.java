...
public class LuzTeste implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		luz1.setPower(true);
		AppImpressao.relatorio("Configuração da 'Luz quarto Nina'", luz1);
		...
		luz2.setPower(true);
		AppImpressao.relatorio("Configuração da 'Luz quarto suíte'", luz2);
		...
		luz3.setVolumeSom(0);
		luz3.setPower(false);
		AppImpressao.relatorio("Configuração da 'Luz Cozinha'", luz3);
	}
}
